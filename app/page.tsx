...
const services = [
  {
    slug: "strategy",
    title: "Chiến lược Kỹ thuật số & Marketing",
    label: "Digital & Marketing Strategy",
    items: [
      "Tư vấn chuyển đổi số",
      "Xây dựng chiến lược thương hiệu",
      "Tối ưu phễu chuyển đổi",
      "Tập trung kết quả kinh doanh thực tế",
    ],
  },
  {
    slug: "content",
    ...
    items: [
      "Copywriting website và ứng dụng",
      "SEO và nội dung mạng xã hội",
      "Email marketing",
      "Inbound marketing",
    ],
  },
  {
    ...
    items: [
      ...
      "Thiết kế đồ họa",
      "Thiết kế UX/UI",
      "Tối ưu quy trình tăng chuyển đổi",
    ],
  },
  {
    slug: "video",
    ...
    items: [
      ...
      "Video cho website với chi phí tối ưu",
    ],
  },
  {
    slug: "technology",
    title: "Phát triển Công nghệ thông tin",
    label: "IT Development",
    items: [
      "Website thương mại điện tử và doanh nghiệp",
      "Microsite và ứng dụng di động",
      "Web app, trò chơi, công cụ sự kiện",
      "Hệ thống đặt chỗ",
    ],
  },
  {
    slug: "performance-ads",
    title: "Quảng cáo & Chuyển đổi",
    label: "Advertising & Conversion",
    items: [
      "Chiến dịch tăng nhận diện",
      "Quảng cáo tập trung chuyển đổi",
      "Nhắm đúng mục tiêu khán giả",
      "Ưu tiên kết quả thay vì lượt thích",
    ],
  },
  {
    slug: "kol-koc",
    title: "Booking KOL/KOC",
    label: "Influencer Booking",
    items: [
      "Booking KOLs và KOCs",
      "Lan truyền thông điệp thương hiệu",
      "Tăng độ tin cậy trên mạng xã hội",
      "Khuếch đại truyền thông nhanh chóng",
    ],
  },
];
